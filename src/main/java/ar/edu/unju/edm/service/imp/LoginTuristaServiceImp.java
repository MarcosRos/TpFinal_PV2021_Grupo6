...
public class LoginTuristaServiceImp implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
		...
		Turista turistaEncontrado=turistaDAO.findByEmail(email).orElseThrow(()-> new UsernameNotFoundException("Turista no válido"));
		
		List<GrantedAuthority> tipos = new ArrayList<>(); 
		GrantedAuthority grantedAuthority = new SimpleGrantedAuthority(turistaEncontrado.getTipo());
